    ...
    registerVectorType(typeName) {
        ...
        return this.registerType(typeName, function encodeVector(writer, data, typeParams, typeMap) {
            ...
            return reader.readVec((reader) => {
                ...
                let { name: innerName, params: innerParams } = this.parseTypeName(typeMap[name]);
                return this.getTypeInterface(innerName)._decodeRaw.call(this, reader, innerParams, typeMap);
            });
        });
    }
    /**
 ...
 */
export function registerPrimitives(bcs) {
...
export function getSuiMoveConfig() {
    return {
        genericSeparators: ['<', '>'],
        vectorType: 'vector',
        addressLength: SUI_ADDRESS_LENGTH,
